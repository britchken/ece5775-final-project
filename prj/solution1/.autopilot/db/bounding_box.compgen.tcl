...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bb_top_V_din { O 32 vector } bb_top_V_full_n { I 1 bit } bb_top_V_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bb_bottom_V_din { O 32 vector } bb_bottom_V_full_n { I 1 bit } bb_bottom_V_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bb_left_V_din { O 32 vector } bb_left_V_full_n { I 1 bit } bb_left_V_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bb_right_V_din { O 32 vector } bb_right_V_full_n { I 1 bit } bb_right_V_write { O 1 bit } } \
} "
}
