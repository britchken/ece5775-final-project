...
set C_modelArgList { 
	...
	{ err_V int 32 regular {fifo 0 volatile}  }
	{ val_V_V int 1 regular {fifo 0 volatile}  }
}
...
set portList { 
	...
	{ bb_top_V_dout sc_in sc_lv 32 signal 6 } 
	{ bb_top_V_empty_n sc_in sc_logic 1 signal 6 } 
	{ bb_top_V_read sc_out sc_logic 1 signal 6 } 
	{ bb_bottom_V_dout sc_in sc_lv 32 signal 7 } 
	{ bb_bottom_V_empty_n sc_in sc_logic 1 signal 7 } 
	{ bb_bottom_V_read sc_out sc_logic 1 signal 7 } 
	{ bb_left_V_dout sc_in sc_lv 32 signal 8 } 
	{ bb_left_V_empty_n sc_in sc_logic 1 signal 8 } 
	{ bb_left_V_read sc_out sc_logic 1 signal 8 } 
	{ bb_right_V_dout sc_in sc_lv 32 signal 9 } 
	{ bb_right_V_empty_n sc_in sc_logic 1 signal 9 } 
	{ bb_right_V_read sc_out sc_logic 1 signal 9 } 
	{ err_V_dout sc_in sc_lv 32 signal 10 } 
	{ err_V_empty_n sc_in sc_logic 1 signal 10 } 
	{ err_V_read sc_out sc_logic 1 signal 10 } 
	{ val_V_V_dout sc_in sc_lv 1 signal 11 } 
	{ val_V_V_empty_n sc_in sc_logic 1 signal 11 } 
	{ val_V_V_read sc_out sc_logic 1 signal 11 } 
}
...
set Spec2ImplPortList { 
	...
	err_V { ap_fifo {  { err_V_dout fifo_data 0 32 }  { err_V_empty_n fifo_status 0 1 }  { err_V_read fifo_update 1 1 } } }
	val_V_V { ap_fifo {  { val_V_V_dout fifo_data 0 1 }  { val_V_V_empty_n fifo_status 0 1 }  { val_V_V_read fifo_update 1 1 } } }
}
