set moduleName rgb2bw
set isCombinational 0
set isDatapathOnly 0
set isPipelined 0
set pipeline_type none
set isOneStateSeq 0
set C_modelName rgb2bw
...
set C_modelArgList { 
	...
	{ bw_data_stream_0_V int 8 regular {fifo 1 volatile}  }
}
...
set portList { 
	...
	{ bw_data_stream_0_V_din sc_out sc_lv 8 signal 5 } 
	{ bw_data_stream_0_V_full_n sc_in sc_logic 1 signal 5 } 
	{ bw_data_stream_0_V_write sc_out sc_logic 1 signal 5 } 
}
...
set Spec2ImplPortList { 
	...
	bw_data_stream_0_V { ap_fifo {  { bw_data_stream_0_V_din fifo_data 1 8 }  { bw_data_stream_0_V_full_n fifo_status 0 1 }  { bw_data_stream_0_V_write fifo_update 1 1 } } }
}
