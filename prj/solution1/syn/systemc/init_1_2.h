...
#ifndef _init_1_2_HH_
#define _init_1_2_HH_
...
struct init_1_2 : public sc_module {
    ...
    // Module declarations
    init_1_2(sc_module_name name);
    SC_HAS_PROCESS(init_1_2);
    ...
    sc_signal< sc_lv<12> > tmp_42_fu_33_p1;
