...
architecture behav of init is 
    ...
    signal tmp_36_fu_33_p1 : STD_LOGIC_VECTOR (11 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_ST_st1_fsm_0 = ap_CS_fsm) and not(ap_sig_bdd_31))) then 
                    ap_return_2_preg <= tmp_36_fu_33_p1;
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_ST_st1_fsm_0 = ap_CS_fsm) and not(ap_sig_bdd_31))) then 
                    ap_return_3_preg <= tmp_36_fu_33_p1;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_return_2_assign_proc : process(ap_CS_fsm, ap_sig_bdd_31, tmp_36_fu_33_p1, ap_return_2_preg)
    begin
        if (((ap_ST_st1_fsm_0 = ap_CS_fsm) and not(ap_sig_bdd_31))) then 
            ap_return_2 <= tmp_36_fu_33_p1;
        else 
    ...
    ap_return_3_assign_proc : process(ap_CS_fsm, ap_sig_bdd_31, tmp_36_fu_33_p1, ap_return_3_preg)
    begin
        if (((ap_ST_st1_fsm_0 = ap_CS_fsm) and not(ap_sig_bdd_31))) then 
            ap_return_3 <= tmp_36_fu_33_p1;
        else 
    ...
    tmp_36_fu_33_p1 <= p_cols(12 - 1 downto 0);
